...
SEQUENCE=$3
VERSION=$4
COLLECTION_PROFILE_PATH=chaincode/$(CHAINCODE_NAME) #THE chaincode name must be same as the forlder name under chaincode



echo "========= Installing the newest chaincode ========="
echo "Chaincode name: $CHAINCODE_NAME"
peer lifecycle chaincode package "chaincode/$CHAINCODE_NAME/$CHAINCODE_PACKAGE_NAME" -p "chaincode/$CHAINCODE_NAME" -l node
