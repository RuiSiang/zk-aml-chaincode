...
If you are using javascript for your chaincode:

.. code:: sh

  cd abstore/javascript
  npm install 
...
If you are using javascript for your chaincode, to run the chaincode:

.. code:: sh

  CORE_CHAINCODE_ID_NAME=mycc:0 CORE_PEER_TLS_ENABLED=false npm start  -- --peer.address peer:7052
